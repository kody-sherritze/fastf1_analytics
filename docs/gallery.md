...
- :material-chart-bar: **2024 Drivers' Championship – Cumulative points**
  ...
  `Source:` [tools/plots/driver_championship.py](https://github.com/ksherr0/fastf1_portfolio/blob/feat/time-in-first/tools/plots/driver_championship.py)  
...
- :material-chart-bar: **2024 Time Spent Leading – Cumulative**
  ...
  `Source:` [tools/plots/time_in_first.py](https://github.com/ksherr0/fastf1_portfolio/blob/feat/time-in-first/tools/plots/time_in_first.py)  
...
- :material-chart-bar: **2025 Italian Grand Prix – DRS effect on main straight (VER)**
  ...
  `Source:` [tools/plots/drs_effectiveness.py](https://github.com/ksherr0/fastf1_portfolio/blob/feat/time-in-first/tools/plots/drs_effectiveness.py)  
...
- :material-chart-bar: **2025 Italian Grand Prix – Tyre Strategy**
  ...
  `Source:` [tools/plots/tyre_strategy.py](https://github.com/ksherr0/fastf1_portfolio/blob/feat/time-in-first/tools/plots/tyre_strategy.py)  
